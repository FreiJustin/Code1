...
function cheese() {
    if (hascheese === false) {
        ...
        let prompttext = "You returned to the cheese, but... The cheese is already in your possesion! Maybe you saw an illusion of the cheese because of blood loss. There is nothing you can do here anymore. \n \n where do you want to go next? \nGo to the CAVE or visit your HOLE?";
        let word = prompt(prompttext, "cave");
        word = word.toLowerCase();
        switch (word) {
            case "cave":
                cave();
...
function trust() {
    if (hascheese === true) {
        let prompttext = "Of course you trust a furry fellow. You can use any help you can get. You still have the cheese you got from the nasty trap. \n \nWould you like to SHARE your cheese with the cat or KEEP the cheese for yourself?";
        let word = prompt(prompttext, "keep");
        word = word.toLowerCase();
        switch (word) {
            case "share":
                share();
